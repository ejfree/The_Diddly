...
**Activate** Interact (ingested)
**Saving Throw** DC 12 Fortitude
**Onset** 10 minutes

| Stage | Effect |
|-------|--------|
| 1 | +1 item bonus to saving throws against fear (10 minutes) |
| 2 | Off-Guard, +1 item bonus to saving throws against fear (10 minutes) |
| 3 | Clumsy 1, off-guard, Stupefied 2 (10 minutes) |
| 4 | Clumsy 2, Sickened 2 (10 minutes) |
| 5 | Clumsy 2, Sickened 2, Stupefied 2 (10 minutes) |
| 6 | Unconscious (8 hours) |
| 7 | Death |
...
> *"Let's have a drink. You want the usual?"*

There are exactly three ways this goes.
...
*Island nation of samurai, kami, and kitsune; cherry blossoms and cedar-aged spirits.*

| Name | Type | Tasting Notes |
|------|------|----------------|
| Silver Crane Whiskey | Whiskey | Rice-malt, cedar-cask aged, faint cherry blossom on the finish |
...
| Nine-Tailed Whiskey | Whiskey | Named for kitsune legend — the finish seems to change with every sip |

---

## Jinin

*Heart of the Dragon Empires, seat of the Iron Dragon Empress; bold, imperial, spice-forward.*

| Name | Type | Tasting Notes |
|------|------|----------------|
| Iron Dragon Whiskey | Whiskey | Sorghum-mash whiskey, five-spice heat that lingers like a coal |
| Jade Empress Brandy | Brandy | Lychee and osmanthus, an imperial reserve poured for honored guests |
| Celestial Ember Gin | Gin | Juniper cut with star anise and dried goji berry |
| Dragon Scale Whiskey | Whiskey | Smoky sorghum whiskey with a Sichuan peppercorn tingle |
...
*The Celestial City, capital of Jinin — refined, ceremonial, reserved for court and temple.*
...
*Steppe nation of riders and khans; harsh, portable, unpretentious spirits.*

| Name | Type | Tasting Notes |
|------|------|----------------|
| Steppe Rider Vodka | Vodka | Clear grain spirit, sharp and utterly unadorned |
| Milk of the Steppe | Vodka | Distilled from fermented mare's milk — tangy, strange, and strong |
| Golden Horde Whiskey | Whiskey | Bold and unforgiving, named for the old conquerors |
| Eternal Sky Gin | Gin | Wild steppe herbs and juniper, tastes of open horizon |
...
*Hidden mountain nation, sealed off from the world; secretive, rarely exported.*
...
*Independent city-state, once part of Minkai; eclectic tavern and market spirits.*
...
*Undead-ruled nation of ancestor reverence; somber, funerary, unnervingly smooth spirits.*
...
*Naga-ruled swampland; exotic, venomous-sounding, jungle-steeped spirits.*

| Name | Type | Tasting Notes |
|------|------|----------------|
| Serpent Coil Whiskey | Whiskey | Steeped with exotic root, fiery, favored by swamp hunters |
| Venom Ember Gin | Gin | Sharp botanicals drawn from marsh herbs, a biting finish |
...
*Coastal peninsula; briny, citrus-bright spirits shaped by the sea.*

| Name | Type | Tasting Notes |
|------|------|----------------|
| Coastal Ember Whiskey | Whiskey | Sea-salt finished, faintly briny on the tongue |
...
*Mountain range nation; austere, mineral, high-altitude spirits.*

| Name | Type | Tasting Notes |
|------|------|----------------|
| Highland Ember Whiskey | Whiskey | Mountain-grown grain, rustic and full-bodied |
...
*Nation renowned for its elders and long-lived sages; medicinal, deeply aged spirits.*
...
*Forest nation; resinous, herbal, woodland spirits.*
...
*Cosmopolitan trade hub city-state; blended, well-traveled spirits.*
...
*Homeland of the kitsune; playful, beguiling, shape-shifting spirits.*

| Name | Type | Tasting Notes |
|------|------|----------------|
| Fox Fire Whiskey | Whiskey | Tricky and warm — regulars swear it tastes different every time |
...
*Remote, little-visited nation; austere, rarely-exported spirits.*
...
*Scattered tropical islands; bright, cane-and-citrus spirits from the water's edge.*

| Name | Type | Tasting Notes |
|------|------|----------------|
| Island Ember Rum | Rum | Dark tropical cane spirit, rich and full-bodied |
| Reef Gold Rum | Rum | Lighter style, citrus peel and salt air |
...
*Refuge nation of humble mountain settlements; modest, grounding spirits.*
...
*Jungle nation of dense canopy and hidden ruins; humid, exotic, root-steeped spirits.*

| Name | Type | Tasting Notes |
|------|------|----------------|
| Jungle Canopy Whiskey | Whiskey | Exotic grain spirit with a humid, heavy warmth |
