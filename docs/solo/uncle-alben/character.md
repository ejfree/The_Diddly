...
Dexterity and Intelligence have never been boosted.

---

## Defenses

**AC** 30 (10 + 0 Dex + 13 trained heavy armor proficiency + 7 item bonus from +1 Resilient Full Plate)
**Hero Points** 1 / 3
**HP** 153 / 153 (Ancestry 10 + Class 8/level × 11 + Con 4/level × 11 + Toughness +1/level × 11)
**Resolve/Recovery:** Toughness reduces recovery check DC by 1 (from Toughness general feat)

| Save | Proficiency | Total |
|------|-------------|-------|
| Fortitude | Expert | +19 (Con +4, expert bonus +15) |
| Reflex | Expert (via Reflex Expertise feat) | +15 (Dex +0, expert bonus +15) |
| Will | Master (via Resolute Faith feat) | +21 (Wis +4, master bonus +17) |
...
- **Undying Ferocity:** whenever Orc Ferocity triggers, Alben also gains temporary HP equal to his level (11).
...
**Perception** Expert, total +19 (Wis +4, expert bonus +15) — improved via the **Perception Expertise** class feature.
**Senses:** Darkvision
...
| Diplomacy | Expert | +18 | Trained from Barkeep background |
| Intimidation | Trained | +16 | — |
| Medicine | Trained | +17 | — |
| Nature | Trained | +17 | Trained via Beast Trainer feat |
| Occultism | Untrained | +0 | — |
| Performance | Trained | +16 | **New:** Trained via Skill Training (Performance), supporting the Gladiator archetype |
| Religion | Master | +21 | — |
| Society | Untrained | +0 | — |
| Stealth | Untrained | +0 | — |
| Survival | Untrained | +4 | — |
| Thievery | Untrained | +0 | — |
| **Lore: Alcohol** | Trained | +13 | Trained from Barkeep background |
...
- **Zealous Rush** (class feat, 8th): Reaction — after casting a 1+ action divine spell affecting only himself/his equipment, Stride up to 10 feet (or full Speed if the spell took 2+ actions).

### Archetype (Gladiator)

- **Gladiator Dedication** (archetype feat, 2nd): Grants the Additional Lore general feat for Gladiatorial Lore. At the start of a combat encounter with spectators, gain temporary HP equal to his character level for 1 minute, and he can roll Performance for initiative instead of Perception.
- **Play to the Crowd** (archetype feat, 4th): Trigger — reduce an enemy to 0 HP during a non-trivial encounter with spectators. Attempt a Performance check (DC set by GM, typically standard level DC or Make an Impression DC, whichever is higher); success grants one benefit, critical success grants two: temporary HP equal to character level (1 minute), +1 circumstance bonus to AC until end of next turn, or +1 circumstance bonus to next attack roll before end of next turn.
...
- **Sanguine Tenacity** (11th): see Defenses above.
...
| Level | Feat/Feature |
|-------|-------------|
| 1 | Hobnobber, Deity (Cleric), Cleric Spellcasting, Doctrine, Warpriest, First Doctrine, First Doctrine (Warpriest), Shield Block, Deadly Simplicity, Divine Font (Healing), Beast Trainer, Pet, Train Animal, Toughness |
| 2 | Glad-Hand, Skill Training (Performance), Gladiator Dedication, Warpriest's Armor |
| 3 | Second Doctrine, Second Doctrine (Warpriest), Perception Expertise, Reflex Expertise, Thorough Search |
| 4 | Restorative Strike, Play to the Crowd |
| 5 | Orc Ferocity |
| 6 | Channel Smite, Performative Weapons Training |
| 7 | Third Doctrine, Third Doctrine (Warpriest) |
| 8 | Cast Down, Zealous Rush, Living for the Applause |
| 9 | Resolute Faith, Undying Ferocity |
| 10 | Titan Wrestler, Eyes of the City, Big Debut |
