...
1. **The Harvest** — Not picking so much as stripping: Alben works a stand of rambutan trees the way other people work a quarry, hauling down every fruit within reach regardless of what state it's in — husked and mashed, pit and all (the pit is where the real bitterness lives, and bitterness is the point). Jungle-orc tradition doesn't believe in a "ripening window" so much as a deliberate refusal to sort: the best Rambui comes from the worst possible mix, the most over-ripe fruit gone soft and boozy on the branch thrown in right alongside the most under-ripe fruit still hard, sour, and weeks from ready — with as little in-between, ordinary, reasonably-ripe fruit as Alben can manage to avoid. A "proper" Rambui shouldn't taste like it came from one tree at one moment; it should taste like a fight between a fruit that gave up too early and one that never got the chance to.
...
He's chased rumors of it since — a syrup, thick and gold and impossibly sweet, said to be brewed in vats the size of a keep by people who don't exist in any hold or city he can name. Alben doesn't put much stock in any one version. He puts stock in the idea that if something can be *that* sweet, then whatever Ruining does to sweetness, HFCS would let him take further than he's ever taken anything.
