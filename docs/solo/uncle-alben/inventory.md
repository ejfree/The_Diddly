...
| Item | AC Bonus | Notes |
|------|----------|-------|
| **+1 Resilient Full Plate** | +6 item AC, +1 potency, +1 resilient (bonus to saves vs. targeted spells while worn) | Heavy armor, plate group; Str requirement 4, Dex cap +0, Check Penalty −3, Speed Penalty −10 ft; worn and invested |
| **Wooden Shield** | +2 AC (raised) | Hardness 3, HP 12, BT 6; standard wooden shield |
...
| Item | Level | Price | Capacity | Notes |
|------|-------|-------|----------|-------|
| **Spacious Pouch (Type I)** ×2 | 4 | 75 gp each | 25 Bulk | Extradimensional, magical. Functions like a bag of holding — items inside don't count toward carried Bulk. Alben owns two of these, used to organize his considerable stash of liquor and scrolls (see below). |

---

## Consumables

### Alcohol (stored across both Spacious Pouches)
