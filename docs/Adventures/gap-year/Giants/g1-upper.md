...
<u>**Map**</u>
![65195C56-6D8F-41E6-A912-83F225B22086](/assets/images/65195C56-6D8F-41E6-A912-83F225B22086.jpg)
...
- **Objects**:   Decent Bedroom — hides on floor, bearskin on wall, chair, stool, huge chest, vast bed.

- **Doors & Exits**: Single

- **Special Interactions**: Any noise louder than a whisper risks waking the sleeping giantess (see Inhabitants).

### **Smells & Sounds**

- **Smells**:  Furs, mead, and the closeness of a rarely-aired room.

- **Sounds**:  DC18 — slow, heavy breathing from the bed.
...
- **Visible Loot**: On a shelf **9** feet above the floor are a beaten silver comb set with four pearls  (total value **300** gp), a copper mirror (worth **200** gp), and a large gold hair pin set with a huge pearl **(800** gp total value).
...
- **Objects**:   12 beds, personal gear and clothing scattered throughout.

- **Doors & Exits**: N&S Exits

- **Special Interactions**: The noise in this room is significant enough that shouts from here may not carry clearly to adjacent rooms (DC 18 to hear specific words from outside).
...
- **Lighting**:  Two torches smouldering in wall cressets — dim throughout.

- **Surfaces**:  Stone floor, same as the rest of the steading.

- **Objects**:  10 beds, 10 chests (one per giant), items of clothing hanging from pegs on the walls.

- **Doors & Exits**: Single door.

- **Special Interactions**: The sleeping giants are very deeply asleep. Noise short of combat or direct physical contact will not wake them.
...
- **Lighting**:  Candles and a low brazier — warm and dim.

- **Surfaces**:  Stone floor with rugs and hides.

- **Objects**:   Drapes separating

- **Doors & Exits**: Single

- **Special Interactions**: If the matron is incapacitated, the three servants freeze and do not act unless directly threatened.
...
- **Hostile Threats**:  Only the nasty old matron (the strongest of the group) is inclined to fight, but she dominates the others. If the matron is slain, the three others do not fight, and even cooperate with the party by describing rooms **8, 9,** and **10** (the chiefs sanctums) and telling how to get there safely if they are allowed to have the matron's hoard of treasure.
...
- **Lighting**:  A fireplace on the west wall provides the main light; dim in the corners.

- **Surfaces**:  Rugs and hides over stone.

- **Objects**:   Two tables, five chairs, two stools, pottery flagons and platters, pots and kegs throughout. Trophies cover the walls: animal and monster heads, skulls, skins, arms and armor (eight shields hang directly across from the fireplace).

- **Doors & Exits**: Connects to the main corridor and toward Room 11.

- **Special Interactions**: The eight shields on the wall opposite the fireplace are identical in appearance; only *detect magic* reveals one of them to be magical.
...
- **Surfaces**:  Rugs and hides over stone floor.

- **Objects**:   Bed, small table, chair, stool, two chests, a coffer. Contents of the chests are only clothing.
...
- **Smells**:  Strong cave bear musk — noticeable from the doorway if anyone passes a DC12 Perception check.

- **Sounds**:  The bear is entirely silent. DC 30 to hear any sign of it before it attacks.
...
- **Hidden Loot**: The chests contain only clothing, as she wears her jewelry, but hidden in the straw mattress is a leather pouch with **29** gems in it: one jacinth **(5,000** gp), three emeralds**(1,000** gp each), four topaz **(500** gp each), eight amethysts **(100** gp each), five zircons **(50**gp each), and eight agates **(10** gp each)
...
- **Lighting**:  Dim — no dedicated light source; ambient glow from the adjoining rooms seeps under the doors.

- **Surfaces**:  Hides on the floor over stone.

- **Objects**:   Bed, two chairs, small table with tun of cheap wine, old shield and chief's weapons in corner, chest (clothing only), clothing on pegs, thick chain set into one wall.

- **Doors & Exits**: Connects to Room 10 (private dining room) and to Room 9 (armory). The chain on the wall is sized for the chief's cave bear (in Room 7).

- **Special Interactions**: The old shield and weapons in the corner are mundane — decorative trophies rather than combat-ready gear.

### **Smells & Sounds**

- **Smells**:  Cheap wine, old leather, and furs.

- **Sounds**:  Near silence. The chief is in the Great Hall; this room is empty.
...
- **Lighting**:  Wall torches, kept lit.

- **Surfaces**:  Clean flagstone — noticeably cleaner than the rest of the steading.

- **Objects**:   Personal armor, shields, and arms of the chief arranged on racks and hooks. Better trophies than in Room 6. Four huge fur capes on pegs.

- **Doors & Exits**: Leads to Room 8.

- **Special Interactions**: Items here are the chief's personal collection and best gear — he knows the inventory. Any item removed will be missed.

### **Smells & Sounds**

- **Smells**:  quite clean, smells of polish

- **Sounds**:  Quiet. No one is stationed here.
...
- **Lighting**:  Brazier near the head of the table; fireplace on one wall — warm and reasonably bright.

- **Surfaces**:  Hides on the walls and floor over stone.

- **Objects**:   Long table, great chair, lesser chair, six stools, several shelves, smaller table and chair, mug, paper scraps, old knife, rock paperweight. Skin map of local area hanging on the wall.

- **Doors & Exits**: The secret door to **10A** is merely a hidden door concealed behind a manticore hide hung on the wall.

- **Special Interactions**: The skin map can be studied (DC 15 to read the Giantish labels) — it shows past and planned raid routes, giving the party intelligence on upcoming targets.

### **Smells & Sounds**

- **Smells**:  Old food, pipe smoke, and the faint tang of tallow from the brazier.

- **Sounds**:  Quiet. Empty when the chief is in the Great Hall.
...
- **Objects**:   Trestle tables, benches, stools, roasting spit over fire pit (ox, two sheep, four pigs), barrels and kegs of ale/beer/mead, platters of meat/cheese/bread. Ballista mounted on north wall behind chief's seat, loaded with 6 spears.

- **Doors & Exits**: Multiple entries from the west (kitchens/service areas) and east (storage/barracks). The front passageway enters from the south.

- **Special Interactions**: The ballista fires spears (2d10 damage, 120-foot range). The chief can fire it as a ranged attack from his seat. The din of noise means Perception checks to hear things outside the hall are at a −6 penalty.
...
- **Lighting**:  Torches on the walls.

- **Surfaces**:  Stone floor.

- **Objects**:   30 helmets, 26 shields, 22 spears, nine clubs, three great axes — all giant-sized, stored in racks and stacked against walls.

- **Doors & Exits**: Access from the main corridor.

- **Special Interactions**: None of these items are usable by human-sized creatures.

### **Smells & Sounds**

- **Smells**:  Iron, leather, and old grease.

- **Sounds**:  Quiet — no one stationed here.
...
- **Lighting**:  A single torch; dim throughout.

- **Surfaces**:  Stone floor.

- **Objects**:   12 each of spears, shields, clubs, and axes (all giant-sized). Four great swords (two-handed for man-sized creatures). Two huge iron maces. A sheaf of 6-foot javelins. Shields are racked against the walls — the magical hammer is behind the seventh shield checked.

- **Doors & Exits**: Adjacent to Room 12.

- **Special Interactions**: The magical war hammer radiates magic strongly until it has spoken its *magic mouth* message. Any detect magic in the room will immediately locate it.

### **Smells & Sounds**

- **Smells**:  Metal, rust, and old leather.
...
- **Magical Items**:  Behind the seventh one checked is a magical **war** *hammer +2.* One other hammer is out of sight in a corner, and it is seen by close inspection. This weapon has a *magic mouth* spell placed on it to speak to a dwad: "Here's a kiss for you, runt! " so until it has spoken it will radiate magic very strongly
...
### **Description**
14 main guest - 6 beds, 4 chairs, 4 stools. Chests, tables he cloud giant and the three stone giants (now at #11) are lodged here. There are ***six*** beds, four chairs, four stools, seven chests, and two tables in the room. Various skins and hides cover the floors, several hang on the walls, and there are giant garments on several pegs. All found are worthless, as are the contents of all chests and the four bags tucked under the beds. One torch burns smokily in the west end of the room in a wall sconce; at the other end is what appears to be an unlit torch, but it is actually a *giant slaying* sword belonging to the cloud giant, and if it is touched the special illusion is dispelled. The sword is unique; with 14 intelligence and *8* ego, it speaks the languages of hill, stone and frost giants in addition to Common and its alignment language (Neutral Good). It can,detect enemies, but has no other powers. It is a + 2 weapon, +4 vs. any type of giant.

### **Features & Terrain**

- **Lighting**:  One torch burning smokily at the west end. The east end appears to have an unlit torch in a wall sconce — this is the disguised sword.

- **Surfaces**:  Skins and hides over stone floors; hides on several walls.

- **Objects**:   Six beds, four chairs, four stools, seven chests (all empty/worthless), two tables, giant garments on pegs, four bags under the beds (all worthless). The "unlit torch" at the east end.

- **Doors & Exits**: Single door.

- **Special Interactions**: The "unlit torch" is a *giant slaying* sword under an illusion. Touching it dispels the illusion. The chests and bags contain nothing of value.

### **Smells & Sounds**

- **Smells**:  Furs and the stone-and-mineral smell of stone giants.

- **Sounds**:  Quiet — the guests are in the Great Hall.
...
- **Lighting**:  No dedicated light source — dark when unoccupied.

- **Surfaces**:  Plain stone floor.

- **Objects**:   12 cots, 10 boxes (all empty, no value), four stools, one table, two benches, odds and ends.

- **Doors & Exits**: Standard single door.

- **Special Interactions**: Nothing of note.

### **Smells & Sounds**

- **Smells**:  Stale and musty — this room is infrequently used.
...
- **Lighting**:  No dedicated light source.

- **Surfaces**:  Hides on floors and walls.

- **Objects**:   A few cloaks on pegs, hides on floors and walls. A small chest on a stool in the northeast corner (unlocked).

- **Doors & Exits**: Standard single door.

- **Special Interactions**: The small chest is unlocked. Its contents are dwarven and elven ears — trophies, not treasure — except for one that contains an earring with a gem.

### **Smells & Sounds**

- **Smells**:  Old furs, dust, and something faintly organic from the chest.
...
- **Lighting**:  Multiple cooking fires — bright and hot.

- **Surfaces**:  Flagstone, grease-stained from years of use.

- **Objects**:   Counters along the walls, several tables, benches, stools. Full array of cooking equipment: pots, kettles, bowls, knives, forks, spoons, ladles, spits. Nothing of value.

- **Doors & Exits**: Leads to Room 18 (workroom/storage) and to the Great Hall (Room 11) via a service corridor.

- **Special Interactions**: The orc slaves will run if confronted; the giantess cooks and young ogre servants will run but call for help loudly.

### **Smells & Sounds**

- **Smells**:  Roasting meat, boiling fat, woodsmoke.

- **Sounds**:  The busy clatter of a working kitchen; shouted orders in Giantish.
...
- **Lighting**:  Spill light from the kitchen and a single wall torch — dim.

- **Surfaces**:  Flagstone.

- **Objects**:   Three tables, long counter, stools, benches, kitchen gear. Sacks, boxes, and barrels (flour, dried meal, dried fruit, honey). Cheeses, smoked meats, and sausages hanging from the rafters. Casks of ale, beer, mead, and wine. Loaves of bread on one table.

- **Doors & Exits**: Connects to Room 17 (kitchen). Room 18A at the back is a storage room containing more provisions and the stairs to the lower level.

- **Special Interactions**: 18A is the only access to the dungeon level from the upper works. The stairway entrance is partially screened by stacked barrels.

### **Smells & Sounds**

- **Smells**:  Preserved food, fermented ale, and smoked meat.

- **Sounds**:  Quieter than the kitchen — a storage and prep area.
...
### **Description**
This large common room has various sizes of cots, tables, chairs, stools, and the like. It is cluttered with old clothing and junk. In it are ***six*** giantess maids (non-combatants) and a relatively handsome giant warrior who will immediately do battle in order to show off for his admirers.

### **Features & Terrain**

- **Lighting**:  Dim torches on the walls.

- **Surfaces**:  Stone floor covered with old clothing and scattered junk.

- **Objects**:   Various sizes of cots, tables, chairs, stools, old clothing and junk throughout. A whip hangs beside the door to the east.

- **Doors & Exits**: Door to the east leads directly to Room 22 (Wolf Yard). The whip hanging beside it is the key to controlling the wolves.

- **Special Interactions**: The whip need only be *shown* to the dire wolves in Room 22 to make them cower and fall back. The giant warrior will not call for help unless reduced to half HP; at that point, 60% chance per round of being heard.

### **Smells & Sounds**

- **Smells**:  Old clothes, sweat, and stale food.

- **Sounds**:  Conversation among the giantess maids; the warrior showing off.

### **Inhabitants**

- **Passive Creatures**: ***six*** giantess maids (non-combatants)

- **Hostile Threats**:  The relatively handsome giant warrior will immediately do battle in order to show off for his admirers. He will not raise a cry for help unless brought to half his original hit points or less. On the round this happens, he will raise help by shouting with a 60% chance each round of being heard. (This giant is the dire wolf keeper of area 22, and he has a whip hanging beside the door to the east. The whip need only be shown to the wolves to make them cower and fall back.)
...
- **Lighting**:  Minimal — a single guttering torch.

- **Surfaces**:  Messy stone floor covered in pallets and junk.

- **Objects**:   Pallets and junk; the meager remnants of the slaves' possessions.

- **Doors & Exits**: Standard single door.

- **Special Interactions**: The two orcs here are badly injured (broken bones from giant kicks) and cannot fight, but they are willing informants. They know the kitchen area and Great Hall layout, and crucially, they know about the orc rebellion in the dungeon below.

### **Smells & Sounds**

- **Smells**:  Unwashed bodies and misery.

- **Sounds**:  Quiet suffering; the orcs go silent when they hear anyone approach.
...
- **Surfaces**:  Stone floor buried under 22 heaps of sleeping skins.

- **Objects**:   22 sleeping-skin heaps, knucklebones game on the floor, cups and small casks of beer. The great iron chest is in the corner (locked; key held by the strongest ogre who is in Room 11).

- **Doors & Exits**: Standard single door.

- **Special Interactions**: Noise from this room attracts no attention whatsoever from the rest of the steading.

### **Smells & Sounds**

- **Smells**:  Extremely pungent — unwashed ogres and stale beer.

- **Sounds**:  Loud dice game, arguing, drinking.
...
- **Lighting**:  Open stockyard — natural light during the day, dark at night.

- **Surfaces**:  Dirt and mud, open to the sky.

- **Objects**:   Nothing of note — an open, filthy yard.

- **Doors & Exits**: Connects to Room 19 to the west. The palisade corridor leads east to Rooms 23–25.

- **Special Interactions**: The whip from Room 19, when shown to the wolves, causes them to immediately cower and make no sound. Without it, they howl and attack any non-giant or non-ogre.

### **Smells & Sounds**

- **Smells**:  Wet animal, dung, and damp earth.

- **Sounds**:  Growling, pacing, and the crack of bones — the wolves are always active.
