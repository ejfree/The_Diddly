...
## Pit to G1 Connector — Zanaya's Well to the Steading
...
Check frequency: once per day of travel. On a failure, apply the listed consequence. Critical failure escalates one step. Critical success negates the consequence and grants a +1 circumstance bonus to the next day's check.

**Applicable skills:** Survival (foraging, navigation, tracking), Perception (detecting creatures before they detect you), Athletics (difficult terrain, climbing, water), Stealth (avoiding contact), Medicine (treating exhaustion).
...
**Forage failure:** No food or water found that day. Each creature must eat and drink from rations or gain the fatigued condition. Clean water is the bigger problem — the Drowned Galleries have abundant water but most of it is contaminated (DC 18 Fortitude or sickened 1 for 1d4 days).

**Detect Ambush failure:** A wandering monster gets a surprise round (or equivalent free action in PF2e: first creature to act is the monster with one free Strike before initiative is rolled).

**Exhaustion Threshold:** If the party accumulates this many failed Navigation or Forage checks in a single zone without a full 8-hour rest in a secured camp, each party member gains drained 1 (or increases existing drained by 1). This resets on a full rest.

**Securing camp** requires DC 16 Survival + 1 hour of work to identify a defensible position. In the Drowned Galleries, an additional DC 18 Athletics check is needed to find ground that won't flood. Failure means the party rests but gains no benefit from sleep (still fatigued in the morning).

---

### Wandering Monster Tables

Roll d100. Check frequency: once per 8 hours of travel, once per 8 hours of rest. During rest, on a result of 01–10 in any zone, the encounter occurs while the party is sleeping (sentries may detect first — Perception DC = creature's Stealth DC).

These tables feed into the G1 surface/dungeon tables as the party gets closer. Once inside G1 Lower, use the original G1 Dungeon Wandering table from `gdq-dev.md`.
...
| 07–13 | 2d6 Darkmantles | Lvl 1 each |
| 14–20 | 1d6 Grimlocks | Lvl 2 each |
| 21–26 | 1 Otyugh (in a refuse chamber) | Lvl 5 |
| 27–32 | 1d4 Shadows (no light source nearby) | Lvl 4 each |
| 33–38 | 1 Cloaker (disguised as a rock formation) | Lvl 5 |
| 39–44 | 2d4 Dero Strangers | Lvl 2 each |
| 45–52 | 1d6 Giant Centipedes | Lvl 1 each |
| 53–58 | 1 Gelatinous Cube (perfectly silent, fills corridor) | Lvl 3 |
| 59–64 | 1d4 Cave Trolls | Lvl 5 each |
| 65–70 | 2d6 Troglodytes | Lvl 2 each |
| 71–76 | 1 Roper (stalagmite-shaped, motionless until close) | Lvl 10 |
| 77–82 | 1d4 Giant Spiders | Lvl 1 each |
| 83–88 | 1 Xorn (wants minerals, not hostile unless threatened) | Lvl 7 |
| 89–94 | 2d4 Morlocks | Lvl 2 each |
| 95–98 | 1 Intellect Devourer (attached to a corpse it's been driving) | Lvl 5 |
| 99–00 | Khyber Tremor — no combat; DC 18 Reflex or knocked prone, 3d6 falling rocks (DC 20 Reflex for half) | — |
...
| d100 | Encounter | PF2e Level |
| --- | --- | --- |
| 01–06 | 2d6 Bugbear Thugs | Lvl 3 each |
| 07–13 | 1d6+2 Ghouls (drawn to the giant campsites) | Lvl 2 each |
| 14–20 | 1 Ogre (lone scout, carrying a message for the Steading) | Lvl 3 |
| 21–26 | 2d4 Troglodytes with 1 Troglodyte King | Lvl 2 / Lvl 5 |
| 27–32 | 1 Wyvern (nested in a high chamber, hunting) | Lvl 6 |
| 33–38 | 1 Cave Bear (territorial, not aggressive if given space) | Lvl 4 |
| 39–44 | 2d6 Giant Bats (disturbed by torchlight) | Lvl 2 each |
| 45–52 | 1 Basilisk (petrified prey scattered around it) | Lvl 5 |
| 53–58 | 1 Doppelganger (impersonating a recently dead traveler) | Lvl 3 |
| 59–64 | 1 Will-o'-Wisp (leads party toward Zone 1 hazards) | Lvl 6 |
| 65–70 | 1 Troll + 1d4 Ogres (troll leads a raiding pack) | Lvl 5 / Lvl 3 |
| 71–76 | 1 Mimic (door-shaped, blocking a junction) | Lvl 4 |
| 77–82 | 1d6 Grimlocks armed with giant-made weapons | Lvl 2 each |
| 83–88 | 1 Animated Giant Skeleton (remains of a hill giant, risen) | Lvl 7 |
| 89–94 | 3 Ogres (returning to Steading, drunk on fermented something) | Lvl 3 each |
| 95–98 | 1 Stone Giant (lost; neutral; knows the Steading exists) | Lvl 9 |
| 99–00 | Fungal Bloom — spores fill a 60-foot section; DC 16 Fortitude or stupefied 1 for 24 hours | — |
...
| 07–13 | 1d4 Merrow (aquatic ogres; territorial in the deeper channels) | Lvl 4 each |
| 14–20 | 1 Chuul (in a submerged arch, reaches through) | Lvl 7 |
| 21–26 | 2d6 Drowned Dwarf Zombies (from the old survey teams) | Lvl 1 each |
| 27–32 | 1 Sea Hag (living in a flooded dwarven vault, hoard of survey tools) | Lvl 4 |
| 33–38 | 1d6 Giant Eels | Lvl 3 each |
| 39–44 | 1d4 Kuo-Toa Monitors (D1/D2 preview; they have descended this far scouting) | Lvl 3 each |
| 45–52 | 1 Water Elemental (Medium; loose from a flooded binding circle in the ruins) | Lvl 5 |
| 53–58 | 1d6 Draugr (ancient dwarven dead, awakened by the flooding) | Lvl 2 each |
| 59–64 | 1 Bog Mummy (preserved in mineral water for centuries) | Lvl 5 |
| 65–70 | 2d4 Giant Crabs | Lvl 2 each |
| 71–76 | 1 Cave Troll + flooding — the troll drives the party into rising water (Athletics DC 18 to cross before it fills) | Lvl 5 |
| 77–82 | 1 Aboleth (in a deep pool, does not pursue beyond water but casts from depth) | Lvl 12 — flee or negotiate |
| 83–88 | 1d4 Kuo-Toa Whips (further scouts; these will tail the party and report to D1) | Lvl 4 each |
| 89–94 | Partial collapse — DC 20 Reflex or trapped under rubble (DC 22 Athletics or 1 minute to free); blocks one corridor | — |
| 95–98 | 1 Water Orm (ancient, vast, fills the main flooded channel) | Lvl 8 — circumvent, don't fight |
| 99–00 | Flash flood — DC 22 Athletics to reach high ground; failure means 60 feet swept back, 4d6 bludgeoning | — |
...
| d100 | Encounter | PF2e Level |
| --- | --- | --- |
| 01–08 | 1d4 Hill Giants (standard patrol, torches) | Lvl 7 each |
| 09–16 | 1d6+2 Ogres (work crew moving timber or provisions) | Lvl 3 each |
| 17–23 | 1 Cave Troll (chained to a post as a guard; chain is 30 feet) | Lvl 5 |
| 24–30 | 2d6 Dire Wolves (hunting pack, loose from the Wolf Yard above) | Lvl 3 each |
| 31–37 | 1 Verbeeg + 2 Ogres (verbeeg gives the orders) | Lvl 6 / Lvl 3 |
| 38–44 | 2 Hill Giants arguing loudly (DC 24 Stealth to pass unseen) | Lvl 7 each |
| 45–51 | 1d6 Cave Bears (kept as giant pets; 60% chance on a chain, 40% loose) | Lvl 4 each |
| 52–58 | 2d6 Orc Slaves (fleeing from above; panicked, not hostile; have useful intel about upper level) | Lvl –1 each |
| 59–65 | 1 Hill Giant + 1d4 Dire Wolves on leash (inspection patrol) | Lvl 7 / Lvl 3 |
| 66–72 | 2d4 Bugbears (giant-allied; acting as outriders and scouts) | Lvl 3 each |
| 73–78 | 1 Stone Giant (visiting the Steading for the alliance; curious, not immediately hostile) | Lvl 9 |
| 79–84 | 3 Ogres + 1 Ogre Spider (spider pulls the supply cart) | Lvl 3 / Lvl 6 |
| 85–90 | 1 Hill Giant Chief's Guard (elite, Lvl 9; doing a perimeter check) | Lvl 9 |
| 91–95 | Giant Fire Beetles loose in the tunnel (escaped from storage; no combat, but the light draws the next roll on this table in 10 minutes) | Lvl 1 each |
| 96–98 | Alarm trip — a crude giant-made tripwire of bones and pots; DC 22 Perception to spot; if triggered, roll 01–08 on this table immediately | — |
| 99–00 | The Keeper's Inspection — the Keeper himself (from Room 27) is walking the tunnel; if combat, the gong from Room 26 is struck on his second round | Boss |
...
### Arrival: Room 36 — Subterranean Lake (Eastern Shore)

On the final approach the tunnel slopes upward, the walls become drier, and a draft of cold, slightly stale air begins to flow back against the party. The trail markers change — the crude Jotun pictographs are replaced by painted arrows, more deliberate, on regularly spaced rocks. This section has been used by the giants long enough to become a proper road.

The tunnel opens abruptly onto the eastern shore of a wide, utterly still underground lake.

**Read aloud (arrival):**
> *The passage ends at a stone shelf, two feet above water level. Before you, a lake of absolute blackness stretches in every direction — your light reaches only thirty feet before the darkness swallows it. The ceiling is low and drips. The water is perfectly still. The far shore is invisible. Nothing moves. But the smell is wrong: beneath the clean cold mineral water there is something else — rancid fat, old smoke, the distant stench of unwashed bodies. Something lives here. Something larger than the eyeless fish that flicker at the edge of your light, pale as bone.*

The four pale giant lizards (Room 36 inhabitants) will likely detect the party on arrival via vibration and smell — they are territorial and regard the eastern passage as their perimeter.

**Navigation across the lake:**
The far shore (where the main dungeon begins) is 200 feet across. No boat or raft is present. Options: swim (cold water, lizard threat), magical movement, improvised float. The stone bridge of Room 34 (the underground stream) is not visible from here — it lies to the north through a low arch, accessible by following the western shore if the party circles wide.

**The connection:**
Beyond the far shore's northern wall arch is the dungeon proper — Room 34 is accessible, and from there the party can reach Room 35, 33, 31, and eventually the rest of G1 lower. The giants do not use this route regularly (they use the staircase from Room 18A); this eastern passage is too low-ceilinged for them above Room 36. The party arrives in the dungeon from an angle the inhabitants do not expect.
...
#### Room 36 — Subterranean Lake (Eastern Shore)

**Wallpaper:**
> an underground lake of utterly still black water stretching into infinite darkness, a low dripping limestone ceiling pressing down close, a stone shelf at the water's edge with a single adventurer's lantern casting only thirty feet of pale light before the darkness swallows it entirely, pale ghostly shapes of giant lizards barely visible at the edge of the light, the perfect mirror surface of the water reflecting the lantern flame, no far shore visible, absolute stillness and silence, deep underground dread, fantasy RPG atmospheric art, minimal light against maximum dark, cinematic --ar 16:9 --style raw

**Battlemap:**
> top-down tactical map of an underground lake, eastern stone shelf entry point where a tunnel mouth opens onto the shore, still dark water dominating most of the map, a low natural arch to the northwest suggesting further passage, pale giant lizard shapes visible in the shallows near the eastern shore, scattered submerged boulders hinted at beneath the water surface, the western shore barely visible at the map's edge, cold mineral water rendered in deep black and dark blue, stone shelves in warm grey, painterly dungeon map style, no grid, no labels --ar 4:3 --style raw
...
- [council-of-houses.md](../drow/council-of-houses.md) — The destination after G3→D1→D2→D3
