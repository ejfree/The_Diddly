...
- **Surfaces**: Wide natural depression; eight stone basins, 15 feet across and 6 feet deep each

- **Objects**: Assessment pens, medical supplies, apothecary formulary; one pit sealed with a stone cover and iron bolts

- **Doors & Exits**: Tunnel narrows toward the E-sector descent on the far side

- **Special Interactions**: The Pits are not a checkpoint — they do not log traffic. Handlers wave through anyone displaying valid house credentials without much scrutiny. PCs without credentials can attempt to pass as a conditioning crew or a medical detail (Deception DC 14) — Thessivir is the one likely to notice a discrepancy.

### **Smells & Sounds**

- **Smells**:

- **Sounds**: Rhythmic, low sounds from the sealed pit — approximately twice per day, not distress

### **Inhabitants**

- **Passive Creatures**: 6 quaggoths in varying states of conditioning; 14–22 slaves in the assessment pens

- **Hostile Threats**: 2 Dravun handlers (Lvl 4 Rangers, beast-master configuration)

- **Unique NPCs**: Thessivir Dravun — female, Lvl 5 Cleric (Death domain), pragmatic to the point of clinical detachment. The most knowledgeable person at the Pits and the most dangerous to cross. She maintains a field formulary of sedatives, pain compounds, and accelerants developed over twenty years of handler work. She will trade apothecary supplies for information about surface-world medicinal sources — she is always looking for new inputs.
...
- **Visible Loot**: Apothecary supplies; handler equipment

- **Hidden Loot**: Thessivir's field formulary of sedatives, pain compounds, and accelerants
